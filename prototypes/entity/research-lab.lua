...
if data.raw["lab"]["lab"] then
  ...
  data.raw["lab"]["lab"].localised_name = {"item-name.lab-mk1", {"item-name.lab"}}
end
...
labBurner.localised_name = {"item-name.lab-burner", {"item-name.lab"}}
...
labMK2.localised_name = {"item-name.lab-mk2", {"item-name.lab"}}
labMK2.inputs = {
